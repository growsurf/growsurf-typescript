...
[![NPM version](<https://img.shields.io/npm/v/growsurf-typescript.svg?label=npm%20(stable)>)](https://npmjs.org/package/growsurf-typescript) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/growsurf-typescript)
...
```ts
import Growsurf from 'npm:growsurf-typescript';
